    ...
    return (
      <div className="min-h-screen bg-[#0f0f23] text-white pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link to="/about" className="text-gray-400 hover:text-white">返回课程列表</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="mb-12">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-lg mt-2">{course.description}</p>
              <p className="text-gray-500 text-sm mt-1">总课时: {course.totalHours}小时</p>
            </div>
          </div>
        </div>
            ...
            <div key={idx} className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{chapter.hours}课时</p>
                </div>
              </div>
                  ...
                  <div key={i} className="bg-gray-800 rounded-lg p-5">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="space-y-1">
                        {item.steps.map((step, si) => (
                          <li key={si} className="text-gray-300 text-sm flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <pre className="bg-gray-900 rounded-lg p-4 overflow-x-auto text-sm">
                        <code className="text-gray-200">{item.code}</code>
                      </pre>
                    </div>
                  </div>
                ))}

    ...
    <div className="min-h-screen bg-[#0f0f23] text-white pt-24 pb-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="w-24 h-24 mx-auto rounded-full border-4 border-gray-700 overflow-hidden bg-gray-800 mb-6">
            <img 
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {courses.map((tag, idx) => (
              <span key={idx} className="px-3 py-1 bg-gray-800 text-white rounded-full text-sm border border-gray-700">
                {tag}
              </span>
            ))}
          </div>
        ...
        <footer className="pt-12 border-t border-gray-800">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">邮箱: 1578949724@qq.com</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-3">快速链接</h3>
              <div className="space-y-2">
                <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors block">首页</a>
                <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors block">我的课程</a>
              </div>
            </div>
          </div>
